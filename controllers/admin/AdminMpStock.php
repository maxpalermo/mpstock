...
class AdminMpStockController extends ModuleAdminController
{
    ...
    public function initContent()
    {
        ...
        if (Tools::isSubmit('ajax') && !empty(Tools::getValue('action', ''))) {
            ...
            PrestaShopLoggerCore::addLog("AdminMpStock-Ajax call: ".print_r($action_name, 1));
    ...
    function ajaxProcessToggle()
    {
        ...
        PrestaShopLoggerCore::addLog("before toggle: ".(int)$db->getValue($sql));
        //update        
        ...
        PrestaShopLoggerCore::addLog("after toggle: ".$value);
        $output = array();
        PrestaShopLoggerCore::addLog("toggle===true: ".(int)((bool)$value===true));
        if ((bool)$value === true) {
            $output = array(
                'addClass' => $positive,
    ...
    public function ajaxProcessGetProductAutocomplete()
    {
        ...
        PrestaShopLoggerCore::addLog($sql);
        $result = $db->executeS($sql);
        $output = array();
        foreach ($result as $row) {
