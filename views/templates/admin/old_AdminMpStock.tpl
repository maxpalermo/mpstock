        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div id="tabs">
                    <ul>
                        <li><a href="#tabs-1"><i
                                    class="icon icon-list-ul"></i>&nbsp;{l s='Stock document' mod='mpstock'}</a></li>
                        <li><a href="#tabs-2"><i
                                    class="icon icon-list-ul"></i>&nbsp;{l s='Stock movements' mod='mpstock'}</a></li>
                        <li><a href="#tabs-3"><i
                                    class="icon icon-download"></i>&nbsp;{l s='Import document' mod='mpstock'}</a></li>
                        <li><a href="#tabs-4"><i
                                    class="icon icon-barcode"></i>&nbsp;{l s='Quick movement' mod='mpstock'}</a></li>
                        <li><a href="#tabs-5"><i
                                    class="icon icon-cogs"></i>&nbsp;{l s='Stock configuration' mod='mpstock'}</a></li>
                        <li><a href="#tabs-6"><i
                                    class="icon icon-th"></i>&nbsp;{l s='Stock available' mod='mpstock'}</a></li>
                    </ul>
                    <div id="tabs-1">
                        {$tab_document}
                    </div>
